...
export class ComparisonModelComponent2 {
  ...
  fileName = "GTN_&_SPSW_Comparison"
...
//still under development
    ...
    for (let i = 0; i < OORMatchedOBRows.length; i =i + 1){
      //prodware house
      if(JSON.stringify(OORMatchedOBRows[i].Size) !== JSON.stringify(OORMatchedOBRows[i].Size1)){
      ...
      //mode
      if(JSON.stringify(OORMatchedOBRows[i].Quantity) !== JSON.stringify(OORMatchedOBRows[i].OrderQty)){
